$.fn.megamenu=function(e) {
	...
	function i() {
		$(".megamenu li").bind("mouseover", function() {
			...
			var off_set = $(this).children("a").offset().left;
			var off_set2= $(this).children("a").offset().left - $(this).parent().parent().offset().left 
			$(this).children(".megapanel").css("left", off_set2);
		}
		).bind("mouseleave",
		function() {
