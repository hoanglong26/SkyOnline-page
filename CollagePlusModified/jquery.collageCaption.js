        ...
        settings.images.each(
            function(index){
                ...
                */
                ...
                settings.opacity + ';position:relative;"></div><div class="Caption_Content" style="position:relative;">' +
                ...
                */
                ...
                $capbg.css("top", "-"+ (($cap.height() / 2) +12)+ "px");
                $captxt.css("top", "-"+ ($cap.height()+12) +"px");
                /*
                * 
